...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/musicEdit" method="post">
		    <input type="hidden" name="id" value="${music.id}"/>
		        <label>标题</label>
		        <input type="text" id="title" name="title" class="input-xlarge span12"  value="${music.title}" required>
		        <label>图片</label>
		        <input name='filename' type='text' class="input-xlarge" id='url' value="${music.filename}" />
		        <label></label>
