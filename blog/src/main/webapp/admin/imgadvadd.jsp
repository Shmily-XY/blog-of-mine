...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/imgadvAdd" method="post">
		        <label>图片</label>
		        ...
		        <label></label>
                <label>URL</label>
                <input type="text"  name="url" required class="input-xlarge" oninvalid="setCustomValidity('URL不能为空')" oninput="setCustomValidity('');">
		        <label></label>
