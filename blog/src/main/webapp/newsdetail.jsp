...
<html>
  <head>
	...
	<link rel="stylesheet" href="/blog/res/layui/css/layui.css">
  	...
  	<script charset="utf-8" src="/blog/kindeditor/kindeditor.js"></script>
	...
	<script>
		KindEditor.ready(function(K) {
			var editor1 = K.create('textarea[name="note"]', {
				...
				cssPath : '/blog/kindeditor/plugins/code/prettify.css',
    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <c:if test="${news.filename ne ''}">
          ...
          ${news.content }
          <!--  
          <embed src="http://localhost:8088/blog/kindeditor/plugins/ckplayer/ckplayer.swf" flashvars="video=/blog/attached/media/20180320/20180320174122_252.mp4" type="application/x-shockwave-flash" width="550" height="400" autostart="false" loop="true" />
-->
        </div>
      </div>
